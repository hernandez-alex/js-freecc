...
function alphabeticalOrder(arr) {
  // Only change code below this line
  return arr.sort((b, a) => (a > b ? 1 : a < b ? -1 : 0));
  // Only change code above this line
}
...
const squareList = (arr) => {
  // Only change code below this line
  return arr.filter((elem, i, arr) => elem > 0 && elem % 1 === 0)
    .map((elem, i, arr) => elem ** 2)
  ;
  // Only change code above this line
};
...
function getRating(watchList) {
  ...
  let averageRating = watchList
    ...
    .reduce((avg, movie, i, arr) => avg + movie.imdbRating / arr.length, 0);
  // Only change code above this line
...
console.log(first, 0, nonMutatingPush(first, 0, nonMutatingPush(first, 0)));
...
console.log(first, second, nonMutatingConcat(first, second));
...
Array.prototype.myFilter = function (callback) {
  ...
  this.forEach((item, index, arr) => {
    if (callback(item, index, arr)) newArray.push(item);
  });
  // Only change code above this line
  return newArray;
};
